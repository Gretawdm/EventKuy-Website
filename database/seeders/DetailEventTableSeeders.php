...
class DetailEventTableSeeders extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('detail_event_tabel')->insert([ 
            ...
            'nama_event' => 'Maroon 5',
            'ktp' => 'ktp.jpg',
            'deskripsi_event' => 'lorem ipsum dolor sit amet.lorem ipsum dolor sit amet.lorem ipsum dolor sit amet.lorem ipsum dolor sit amet.lorem ipsum dolor sit amet.',
            'contact_person' => '0812345671717',
            'event_organizer' => 'Event_WD',
            'event_owner' => 'Samari',
            'tanggal_event' => '2024-05-08',
            'no_rek' => '1897658904',
