...
<body>
    ...
    <div class="page">
        <h1 class="h3 mb-2 text-gray-800" style="font-size: 25px">Tenant</h1>


        <!-- tabs -->
        <div class="pcss3t pcss3t-effect-scale pcss3t-theme-1">
            <input type="radio" name="pcss3t" checked id="tab1" class="tab-content-first">
            <label for="tab1" onclick="navigateToRoute('semua')"><i class="icon-bolt"></i>Semua</label>

            <input type="radio" name="pcss3t" id="tab2" class="tab-content-2">
            <label for="tab2" onclick="navigateToRoute('diterima')"><i class="icon-picture"></i>Diterima</label>

            <input type="radio" name="pcss3t" id="tab3" class="tab-content-3">
            <label for="tab3" onclick="navigateToRoute('ditolak')"><i class="icon-cogs"></i>Ditolak</label>

            <input type="radio" name="pcss3t" id="tab5" class="tab-content-4">
            <label for="tab5" onclick="navigateToRoute('menunggu_pembayaran')"><i class="icon-globe"></i>Menunggu
                Pembayaran</label>

            <input type="radio" name="pcss3t" id="tab6" class="tab-content-last">
            <label for="tab6" onclick="navigateToRoute('terverifikasi')"><i class="icon-globe"></i>Terverifikasi</label>
