                    ...
                    <tr class="">
                        ...
                        <td class="align-middle text-center">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="#" class="btn btn-warning" style="font-weight: 800;" data-toggle="modal"
                                    data-target="#detailBooth">Detail</a>
                                <form action="{{ route('tenant.terima', ['id' => $order['id_order']]) }}" method="POST"
                                    style="display: inline-block;" onsubmit="return confirm('Setujui Booth Ini?')">
                                    @csrf
                                    <button type="submit" class="btn btn-success"
                                        style="font-weight: 800;">Setuju</button>
                                </form>
                                <form action="{{ route('tenant.tolak', ['id' => $order['id']]) }}" method="POST"
                                    style="display: inline-block;" onsubmit="return confirm('Tolak Booth Ini?')">
                                    @csrf
                                    <button type="submit" class="btn btn-danger"
                                        style="font-weight: 800;">Tolak</button>
                                </form>
                            </div>
                        </td>
                    </tr>
