...
@section('content')
    ...
    <div class="card shadow mt-0 mb-5" style="border-radius:15px">
            ...
            <div class="card col-12">
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3 select-container">
                                    ...
                                    <select class="form-select same-height" aria-label="Default select example"
                                        name="kategori_event" required>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="tanggal" class="form-label">Pelaksanaan Event</label>
                                    <input type="datetime-local" class="form-control" id="tanggal_event"
                                        name="pelaksanaan_event" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-step" id="form-step-2">
                        ...
                        <div class="garis-pemisah"></div> <!-- Garis pemisah -->
                        <label for="exampleUploadEvent" class="form-label mb-2" style="font-size: 20px">Upload Denah
                            Event</label>
                        <script class="jsbin" src="https://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
                    ...
                    <div class=" form-step" id="form-step-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3" style="display: flex; flex-direction:column;">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="accountNumber"
                                                    name="no_rekening"
                                                    placeholder="klik 'search' setelah memasukkan nomor rekening" required>
                                                <div class="input-group-append">
                                                    <button type="button" id="searchButton"
                                                        class="btn custom-bt btn-sm">
                                    ...
                                    <div class="error-message" id="accountNumberError">Gagal mengambil detail
                                        rekening
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3" style="display: flex; flex-direction:column;">
                                    <label for="exampleInputNoRekening" class="form-label">Nama Pemilik
                                        Rekening</label>
                                    <input type="text" class="form-control disabled-input" id="accountHolder"
                                        name="nama_rekening" readonly></input>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3" style="display: flex; flex-direction:column;">
    ...
    <style>
        ...
        .custom-select {
            ...
            /* Sesuaikan dengan tinggi kolom lain */
            padding: 15px;
            font-size: 1rem;
            line-height: 1.5;
            color: #495057;
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.add-booth').click(function() {
                ...
                // Periksa jumlah formulir setelah penambahan
                var boothFormsCount = $('#booth-form-container').children('.booth-form').length;
                // Jika jumlah formulir lebih dari satu, tampilkan tombol "Hapus"
                if (boothFormsCount > 1) {
                    newForm.find('.remove-booth').removeClass('d-none');
                }
            });
            ...
            $(document).on('click', '.remove-booth', function() {
                ...
                // Periksa jumlah formulir setelah penghapusan
                var boothFormsCount = $('#booth-form-container').children('.booth-form').length;
                // Jika jumlah formulir hanya 1, sembunyikan tombol "Hapus" dari formulir pertama
                if (boothFormsCount === 1) {
                    $('#booth-form-container').children('.booth-form').find('.remove-booth').addClass(
                        'd-none');
                }
            });
        });
        ...
        function setEqualHeight() {
            var fileInput = document.getElementById('upload_ktp');
            var selectElements = document.querySelectorAll('.form-select');

            var fileInputHeight = fileInput.offsetHeight;

            selectElements.forEach(function(select) {
                select.style.height = fileInputHeight + 'px';
            });
        }
