                    ...
                    <div class="col-md-6">
                        <div class="mb-3" style="display: flex; flex-direction:column;">
                            <label for="exampleInputPenyelenggara" class="form-label">Penyelenggara
                                Event</label>
                            <input type="text" class="form-control" id="penyelenggara_event" name="penyelenggara_event">
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="form-step">
                ...
                <div class="file-upload-content-pamflet">
                    ...
                    <div class="image-title-wrap-pamflet">
                        <button type="button" onclick="removeUploadPamflet()" class="remove-image-pamflet">Remove <span
                                class="image-title-pamflet">Uploaded
                                Image</span></button>
                    </div>
                </div>
                <div class="btns-group">
