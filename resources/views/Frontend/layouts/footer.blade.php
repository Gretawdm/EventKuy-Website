         ...
         <div class="row gy-4">
             ...
             <div class="col-lg-2 col-6 footer-links">
                 ...
                 <ul>
                     ...
                     <li id="home-link"><a href="index.htl" style="font-weight: 600">Home</a></li>
                     <li id="about-link"><a href="about.html" style="font-weight: 600">About us</a></li>
                     <li id="services-link"><a href="services.html" style="font-weight: 600">Our Services</a></li>
                     <li id="contact-link"><a href="contact.html" style="font-weight: 600">Contact</a></li>
                 </ul>
             </div>
             ...
             <div class="col-lg-2 col-6 footer-links">
                 ...
                 <ul>
                     <li><a href="service.html" style="font-weight: 600">Public Event</a></li>
                     <li><a href="service.html" style="font-weight: 600">Pendaftaran Booth Tenant</a></li>
                     <li><a href="service.html" style="font-weight: 600">Generate Code</a></li>
                 </ul>
             </div>
             ...
             <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
                 ...
                 <p style="font-weight: 600">
                     ...
                     Golongan B <br><br>
                     <strong>Phone:</strong> 0853-1234-7896<br>
                     <strong>Email:</strong> eventkuy5@gmail.com<br>
                 </p>
